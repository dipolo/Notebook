...
public class NotebookDbAdapter {
    ...
    private String[] allColums = {COLUMN_ID, COLUMN_TITLE, COLUMN_MESSAGE, COLUMN_CATEGORY, COLUMN_DATE};
    ...
    public Note createNote(String title, String message, Note.Category category){
        ...
        Cursor cursor = sqlDB.query(NOTE_TABLE, allColums, COLUMN_ID + " = " + insertId, null, null, null, null);
        cursor.moveToFirst();
    ...
    public ArrayList<Note> getAllNotes() {
        ...
        Cursor cursor= sqlDB.query(NOTE_TABLE, allColums, null, null, null, null, null);
    ...
    private static class NotebookDbHelper extends SQLiteOpenHelper{
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w(NotebookDbHelper.class.getName(),
                    ...
                    + newVersion + ", which will destroy alla old data");
